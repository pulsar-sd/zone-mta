...
const MAX_ALLOWED_FRAME_SIZE = (config.queue.max_allowed_frame_size && config.queue.max_allowed_frame_size > 0) ? config.queue.max_allowed_frame_size : 3 * 1024 * 1024; // 3MB
