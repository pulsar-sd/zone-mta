            ...
            <tr>
              <td align="center">
                ...
                <table width="100%" style="border-spacing: 20px; padding-bottom: 28px;">
                  <tr>
                    <td align="center" style="font-size: 12px; line-height: 22px; font-weight: 700;">
                      Follow us
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td align="center" style="font-weight: 700; font-size: 12px;">ePost Service AG</td>
                  </tr>
                  <tr>
                    <td align="center" style="font-size: 12px; line-height: 22px;">
                  ...
                  <tr>
                    <td align="center" style="opacity: 0.5; font-size: 10px;">
    ...
    <tr>
      <td>
        <table
          ...
          ${templateParts.english.pdfNotice}
          ${templateParts.english.appDownload}
          ${templateParts.english.footer}
    </table>
	</td>
  </tr>
</table>`,
        ...
        <table class="email-template"
          ...
          <tr>
            <td style="padding-bottom: 24px;">
              ...
              <div style="font-size: 24px;font-weight: 750; line-height: 31.2px; color: rgb(255, 0, 0)">Register ID: [EID]</div>
            </td>
          </tr>
          <tr>
            <td>
          ...
          <tr>
            <td>
              <div style="font-size: 16px; font-weight: 700; padding-top: 24px; line-height: 24px;">Your registered letter with EID: [EID] was rejected by the recipient. No delivery was made.<br/></div>
            </td>
          </tr>
          <tr>
            <td>
              <div style="font-size: 16px; font-weight: 700; padding-top: 24px; line-height: 24px;">Attached you will find the original email and the receipt as a signed PDF-A with the details of the rejection. The registered letter in question has been deleted.</div>
            </td>
          </tr>
					...
					>
						...
						<td>
							<table style="background-color: #ff3000; height: 90px;padding: 8px; width: 100%;margin-top: 24px;">
								...
								<tr>
									<td align="center">
										<div style="font-size: 14px; font-weight: 400; line-height: 22px;"><a href="https://api.epost.ch/eletter-qr" style="text-decoration: none;color: #000000;text-align:  justify;">[ERR_MSG]</a></div>
									</td>
								</tr>
							</table>
						</td>
						...
						<tr>
							<td>
								<table style="background-color: #FFCC00; height: 90px;padding: 8px; width: 100%;margin-top: 24px;">
									...
									<tr>
										<td align="center">
											<div style="font-size: 14px; font-weight: 400; line-height: 22px;"><a href="https://api.epost.ch/eletter-qr" style="text-decoration: none;color: #000000;">Bewahren sie das PDF für den sp&auml;teren Nachweis des Verfalls des Einschreibens in ihren Unterlagen auf</a></div>
										</td>
									</tr>
								</table>
							</td>
						...
						<tr>
							<td>
								<table style="background-color: #FFCC00; height: 90px;padding: 8px; width: 100%;margin-top: 24px;">
									...
									<tr>
										<td align="center">
											<div style="font-size: 14px; font-weight: 400; line-height: 22px;"><a href="https://api.epost.ch/eletter-qr" style="text-decoration: none;color: #000000;">Bewahren sie das PDF für den sp&auml;teren Nachweis der Ablehnung des Einschreibens in ihren Unterlagen auf</a></div>
										</td>
									</tr>
								</table>
							</td>
          ...
          <td>
            <table style="background-color: #FFCC00; height: 90px;padding: 8px; width: 100%;margin-top: 24px;">
              ...
              <tr>
                <td align="center">
                  <div style="font-size: 14px; font-weight: 400; line-height: 22px;">
                    <a href="https://api.epost.ch/eletter-qr" style="text-decoration: none;color: #000000;">Si prega di conservare il PDF nei propri archivi come prova di trasmissione per posta raccomandata.
                    </a>
                  </div>
                </td>
              </tr>
            ...
            <td>
              <table style="background-color: #FFCC00; height: 90px;padding: 8px; width: 100%;margin-top: 24px;">
                ...
                <tr>
                  <td align="center">
                    <div style="font-size: 14px; font-weight: 400; line-height: 22px;">
                      <a href="https://api.epost.ch/eletter-qr" style="text-decoration: none;color: #000000;">Veuillez conserver ce PDF dans vos archives comme preuve de transmission du courrier recommandé.
                      </a>
                    </div>
                  </td>
                </tr>
