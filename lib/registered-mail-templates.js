  ...
  <tr>
    <td>
      <table style="font-family: Frutiger Neue For Post;width: 430px;margin: auto;background-color: white;font-size: 16px;padding: 40px 56px 0px 56px; min-width: 430px;" align="center" border="0" cellpadding="0" cellspacing="0" width="430" class="email-template">
        <tr>
          <td style="padding-bottom: 24px;">
            <div style="font-size: 24px;font-weight: 750; line-height: 31.2px;">Accusé de réception de la tâche</div>
            ...
            <table style="background-color: #000000; height: 24px;padding: 12px; width: 100%;">
              <tr>
                <td align="left">
                  <div>
                    <a href="https://api.epost.ch/eletter-qr" style="text-decoration: none; color: #ffffff;">
                      <img src="https://api.epost.ch/resources/downloadpage/image/common-file-text-lock.png" alt="icône" width="24" height="24" />
                    </a>
                  </div>
                </td>
                <td>
                  <div style="font-size: 14px; font-weight: 700; padding-left: 16px;"><a href="https://api.epost.ch/eletter-qr" style="text-decoration: none; color: #ffffff;">[OBJET]</a></div>
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td>
            <div style="font-size: 16px; font-weight: 700; padding-top: 24px; line-height: 24px;">Votre courrier recommandé avec ID : [EID] a été accepté sur la plateforme. Le destinataire a été informé. Dès que le destinataire confirme ou refuse la réception, le courrier recommandé sera livré ou supprimé, et vous recevrez un accusé de réception.</div>
          </td>
        </tr>
        <tr>
          <td>
            <div style="font-size: 16px; font-weight: 700; padding-top: 24px; line-height: 24px;">Vous trouverez ci-joint le courriel original soumis pour livraison ainsi que l'accusé de réception au format PDF-A signé avec les détails de la transmission.</div>
          </td>
        </tr>
        <tr>
          <td>
            <table style="background-color: #FFCC00; height: 90px;padding: 8px; width: 100%;margin-top: 24px;">
              ...
              <tr>
                <td align="center">
                  <div style="font-size: 14px; font-weight: 400; line-height: 22px;"><a href="https://api.epost.ch/eletter-qr" style="text-decoration: none;color: #000000;">Veuillez conserver ce PDF dans vos archives comme preuve de transmission du courrier recommandé.</a></div>
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td align="center" style="padding-top: 40px;font-size: 24px; font-weight: 750; line-height: 30px; display: flex; justify-content: center;">
            <table style="width: 100%;">
              <tr>
                <td align="center">Cordialement,</td>
              </tr>
              <tr>
                <td align="center">Votre équipe ePost</td>
              </tr>
            </table>
          </td>
        </tr>
      ...
      <table style="font-family: Frutiger Neue For Post;width: 430px;margin: auto;background-color: white;font-size: 16px;" align="center" border="0" cellpadding="0" cellspacing="0" width="430">
        <tr>
          <td align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-spacing: 20px; padding-bottom: 28px">
              <tr>
                <td align="center" style="font-size: 12px; line-height: 22px; color: #000000; font-weight: 700; text-align: center;">Suivez-nous</td>
              </tr>
              <tr>
                <td align="center">
                  <table align="center" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td align="center" style="padding: 0 12px;"><a href="https://www.facebook.com/ePostSchweiz" target="_blank" rel="noreferrer"><img src="https://www.klara.ch/hubfs/img/emails/icons/social-media/social-media-facebook-black-2x.png" alt="Facebook" width="10" style="max-width: 10px; width: 10px;" /></a></td>
                      <td align="center" style="padding: 0 12px;"><a href="https://www.youtube.com/@epostapp" target="_blank" rel="noreferrer"><img src="https://www.klara.ch/hubfs/img/emails/icons/social-media/social-video-youtube-clip-black-2x.png" alt="YouTube" width="14" style="max-width: 14px; width: 14px;" /></a></td>
                      <td align="center" style="padding: 0 12px;"><a href="https://www.instagram.com/swiss_epost" target="_blank" rel="noreferrer"><img src="https://www.klara.ch/hubfs/img/emails/icons/social-media/social-instagram-black-2x.png" alt="Instagram" width="16" style="max-width: 16px; width: 16px;" /></a></td>
                      <td align="center" style="padding: 0 12px;"><a href="https://www.linkedin.com/company/epost-schweiz" target="_blank" rel="noreferrer"><img src="https://www.klara.ch/hubfs/img/emails/icons/social-media/professional-network-linkedin-black-2x.png" alt="LinkedIn" width="16" style="max-width: 16px; width: 16px;" /></a></td>
                    </tr>
                  </table>
                </td>
              </tr>
              <tr>
                <td align="center" style="font-weight: 700;font-size: 12px;line-height: 22px;text-align: center;">ePost Service AG</td>
              </tr>
              <tr>
                <td align="center" style="font-size: 12px;line-height: 22px;text-align: center;">Schlössli Schönegg - Wilhelmshöhe 1 - 6003 Lucerne - Suisse<br />Une entreprise de La Poste et membre d'Axon World.</td>
              </tr>
              <tr>
                <td align="center" style="font-size: 12px; line-height: 22px;">
                  <table align="center" style="opacity: 50%; font-size: 10px;">
                    <tr>
                      ...
                      <td><a href="https://www.epost.ch/de-ch/agb" target="_blank" rel="noreferrer" style="text-decoration: underline;color: #000000;"><i>CGV</i></a></td>
                    </tr>
                  </table>
                </td>
              </tr>
...
error: `<table id="french-error" class="hidden-content" width="100%" bgcolor="#f2f2f2" border="0" cellpadding="0" cellspacing="0">
  <tr><td>
    <table style="font-family: Frutiger Neue For Post; width: 430px; margin: auto; background-color: white; font-size: 16px; padding: 40px 56px 0 56px; min-width: 430px;" align="center" border="0" cellpadding="0" cellspacing="0" width="430" class="email-template">
      ...
      <tr><td>
        <table style="background-color: #FF3000; height: 90px; padding: 8px; width: 100%; margin-top: 24px;">
          <tr><td align="center" style="padding-bottom: 14px;">
            <div style="font-size: 18px; font-weight: 750;">Erreur !</div>
          </td></tr>
          <tr><td align="center">
            <div style="font-size: 14px; font-weight: 400; line-height: 22px; text-align: justify;">[ERR_MSG]</div>
          </td></tr>
        </table>
      </td></tr>
      ...
      <tr><td>
        <div style="font-size: 16px; font-weight: 700; padding-top: 24px; line-height: 24px;">
          Vous trouverez ci-joint l’email original et l’accusé de réception au format PDF-A signé avec tous les détails de l’erreur. Le courrier recommandé a été supprimé.
        </div>
      </td></tr>
      ...
      <tr><td>
        <table style="background-color: #FFCC00; height: 90px; padding: 8px; width: 100%; margin-top: 24px;">
          <tr><td align="center" style="padding-bottom: 14px;">
            <div style="font-size: 18px; font-weight: 750; color: #000;">Important !</div>
          </td></tr>
          <tr><td align="center">
            <div style="font-size: 14px; font-weight: 400; line-height: 22px;">Veuillez conserver ce PDF comme preuve de la tentative de livraison échouée.</div>
          </td></tr>
        </table>
      </td></tr>
      ...
      <tr><td align="center">
        ...
        <table width="100%" style="border-spacing: 20px; padding-bottom: 28px;">
          ...
          <tr><td align="center">
            <table align="center" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="padding: 0 12px;"><a href="https://www.facebook.com/ePostSchweiz" target="_blank"><img src="https://www.klara.ch/hubfs/img/emails/icons/social-media/social-media-facebook-black-2x.png" alt="Facebook" width="10" /></a></td>
                <td style="padding: 0 12px;"><a href="https://www.youtube.com/@epostapp" target="_blank"><img src="https://www.klara.ch/hubfs/img/emails/icons/social-media/social-video-youtube-clip-black-2x.png" alt="YouTube" width="14" /></a></td>
                <td style="padding: 0 12px;"><a href="https://www.instagram.com/swiss_epost" target="_blank"><img src="https://www.klara.ch/hubfs/img/emails/icons/social-media/social-instagram-black-2x.png" alt="Instagram" width="16" /></a></td>
                <td style="padding: 0 12px;"><a href="https://www.linkedin.com/company/epost-schweiz" target="_blank"><img src="https://www.klara.ch/hubfs/img/emails/icons/social-media/professional-network-linkedin-black-2x.png" alt="LinkedIn" width="16" /></a></td>
              </tr>
            </table>
          </td></tr>
          <tr><td align="center" style="font-weight: 700; font-size: 12px;">ePost Service AG</td></tr>
          <tr><td align="center" style="font-size: 12px; line-height: 22px;">Schlössli Schönegg – Wilhelmshöhe 1 – 6003 Lucerne – Suisse<br/>Une entreprise Swiss Post, membre du groupe Axon.</td></tr>
          <tr><td align="center" style="opacity: 0.5; font-size: 10px;"><a href="https://support.mylife.klara.ch/" style="text-decoration: underline; color: #000; padding-right: 24px;">Centre d’assistance</a><a href="https://www.epost.ch/datenschutzerklaerung" style="text-decoration: underline; color: #000; padding-right: 24px;">Politique de confidentialité</a><a href="https://www.epost.ch/agb" style="text-decoration: underline; color: #000;">Conditions générales</a></td></tr>
        </table>
      </td></tr>
    </table>
  </td></tr>
</table>`,
arrival: `<table id="french-delivery" class="hidden-content" width="100%" bgcolor="#f2f2f2" border="0" cellpadding="0" cellspacing="0">
  <tr><td>
    <table
      style="font-family: Frutiger Neue For Post; width: 430px; margin: auto; background-color: white; font-size: 16px; padding: 40px 56px 0 56px; min-width: 430px;"
      align="center" border="0" cellpadding="0" cellspacing="0" width="430" class="email-template"
    >
      ...
      <tr><td>
        <div style="font-size: 16px; font-weight: 700; padding-top: 24px; line-height: 24px;">
          Votre courrier recommandé (ID : [EID]) a été accepté par le destinataire et livré via [CANAL].
        </div>
      </td></tr>

      <tr><td>
        <div style="font-size: 16px; font-weight: 700; padding-top: 24px; line-height: 24px;">
          Vous trouverez ci-joint l’email original livré ainsi que l’accusé de réception au format PDF-A signé avec les détails de la livraison.
        </div>
      </td></tr>
      ...
      <tr><td>
        <table style="background-color: #FFCC00; height: 90px; padding: 8px; width: 100%; margin-top: 24px;">
          ...
          <tr><td align="center">
            <a href="https://api.epost.ch/eletter-qr" style="text-decoration: none; color: #000; font-size: 14px; font-weight: 400; line-height: 22px;">
              Veuillez conserver ce PDF comme preuve de la bonne livraison.
            </a>
          </td></tr>
        </table>
      </td></tr>
    ...
    <table style="font-family: Frutiger Neue For Post; width: 430px; margin: auto; background-color: white; font-size: 16px;"
      ...
      <tr><td align="center">
        ...
        <table width="100%" style="border-spacing: 20px; padding-bottom: 28px;">
          ...
          <tr><td align="center" style="font-weight: 700; font-size: 12px;">ePost Service AG</td></tr>
          <tr><td align="center" style="font-size: 12px; line-height: 22px;">
            Schlössli Schönegg – Wilhelmshöhe 1 – 6003 Lucerne – Suisse<br/>
            Une entreprise de La Poste Suisse et membre du groupe Axon.
          </td></tr>
          <tr><td align="center" style="opacity: 0.5; font-size: 10px;">
            ...
            <a href="https://www.epost.ch/datenschutzerklaerung" style="text-decoration: underline; color: #000; padding-right: 24px;"><i>Politique de confidentialité</i></a>
            <a href="https://www.epost.ch/agb" style="text-decoration: underline; color: #000;"><i>Conditions générales</i></a>
          </td></tr>
        </table>
      </td></tr>
    </table>
...
timeout: `<table id="french-expiration" class="hidden-content" width="100%" bgcolor="#f2f2f2" border="0" cellpadding="0" cellspacing="0">
  <tr><td>
    <table class="email-template" align="center" width="430" border="0" cellpadding="0" cellspacing="0"
           style="font-family: Frutiger Neue For Post; width:430px; margin:auto; background-color:white; font-size:16px; padding:40px 56px 0 56px; min-width:430px;">
      <!-- En-tête -->
      <tr><td style="padding-bottom:24px;">
        <div style="font-size:24px; font-weight:750; line-height:31.2px; color:#ff0000;">Accusé d’expiration</div>
      ...
      <tr><td>
        <table style="background-color:#000; height:24px; padding:12px; width:100%;"><tr>
          <td align="left">
            <a href="https://api.epost.ch/eletter-qr" style="text-decoration:none;color:#fff;"><img src="https://api.epost.ch/resources/downloadpage/image/common-file-text-lock.png" alt="icône" width="24" height="24" /></a>
          </td>
          <td>
            <div style="font-size:14px; font-weight:700; padding-left:16px;"><a href="https://api.epost.ch/eletter-qr" style="text-decoration:none;color:#fff;">[OBJET]</a></div>
          </td>
        </tr></table>
      </td></tr>
      ...
      <tr><td>
        <div style="font-size:16px; font-weight:700; padding-top:24px; line-height:24px;">
          Votre courrier recommandé (ID : [EID]) n’a pas été récupéré par le destinataire dans les 7 jours. Aucune livraison n’a été effectuée.
        </div>
      </td></tr>
      <tr><td>
        <div style="font-size:16px; font-weight:700; padding-top:24px; line-height:24px;">
      ...
      <!-- Liens App -->
      <tr><td style="display:flex; align-items:center; padding:24px 0;"><table><tr>
        <td style="padding-right:5px;"><a href="https://apps.apple.com/us/app/epost-app/id1571482864" target="_blank"><img src="https://api.epost.ch/resources/downloadpage/image/download_appstore.png" alt="ios" width="152" /></a></td>
        <td align="right"><a href="https://play.google.com/store/apps/details?id=ch.klara.epost" target="_blank"><img src="https://api.epost.ch/resources/downloadpage/image/download_googleplay.png" alt="android" width="152" /></a></td>
      </tr></table></td></tr>

      <!-- Pied de page -->
      <tr><td align="center" style="padding-top:40px; font-size:24px; font-weight:750; line-height:30px; display:flex; justify-content:center;"><table style="width:100%;"><tr><td align="center">Cordialement</td></tr><tr><td align="center">Votre équipe ePost</td></tr></table></td></tr>

    </table>
  </td></tr>
</table>`,
reject: `<table id="french-opening" class="hidden-content" width="100%" bgcolor="#f2f2f2" border="0" cellpadding="0" cellspacing="0">
  <tr><td>
    <table class="email-template"
           width="430"
           align="center"
      ...
      <tr>
        <td style="padding-bottom:24px;">
          <div style="font-size:24px; font-weight:750; line-height:31.2px;">Accusé d’ouverture</div>
          <div style="font-size:24px; font-weight:750; line-height:31.2px;">ID de courrier recommandé : [EID]</div>
        </td>
      </tr>
      ...
      <tr>
        <td>
          <div style="font-size:16px; font-weight:700; padding-top:24px; line-height:24px;">
            Votre courrier recommandé (ID : [EID]) a été ouvert par le destinataire.
          </div>
        </td>
      </tr>
      <tr>
          ...
          <table style="background-color:#FFCC00; height:90px; padding:8px; width:100%; margin-top:24px;">
            ...
            <tr>
              <td align="center">
                <div style="font-size:14px; font-weight:400; line-height:22px;">
                  <a href="https://api.epost.ch/eletter-qr" style="text-decoration:none; color:#000;">
                    Veuillez conserver ce PDF comme preuve de l’ouverture dans vos archives.
                  </a>
                </div>
              </td>
            </tr>
...
read: `<table width="100%" bgcolor="#f2f2f2" border="0" cellpadding="0" cellspacing="0">
  <tr><td>
    <table class="email-template"
           width="430"
           align="center"
          ...
          <table>
            <tr>
              ...
              <td style="padding-right:24px;">
                <a href="https://app.epost.ch/invitation-email?lang=IT&data=[DATA]" target="_blank"
                   style="text-decoration:none;color:#000;">
                  <img src="cid:it.png" alt="Italien" />
                </a>
              </td>
              <td>
                <a href="https://app.epost.ch/invitation-email?lang=EN&data=[DATA]" target="_blank"
                   style="text-decoration:none;color:#000;">
                  <img src="cid:en.png" alt="Anglais" />
                </a>
              </td>
            </tr>
          </table>
...
notification: `<table width="100%" bgcolor="#f2f2f2" border="0" cellpadding="0" cellspacing="0">
  <tr><td>
    <table class="email-template"
           width="430"
           align="center"
      ...
      <tr>
        <td style="padding-bottom: 24px;">
          <div style="font-size: 24px; font-weight: 750; line-height: 31.2px;">
            Un envoi recommandé est en attente de livraison.
          </div>
        </td>
      </tr>
      ...
      <tr>
        <td>
          <div style="font-size:16px; font-weight:700; padding-top:24px; line-height:24px;">
            La livraison chiffrée n’est disponible que via l’application ePost.<br/>
            Le document recommandé sera livré une fois que vous aurez autorisé la réception.
          </div>
        </td>
      </tr>
        ...
        <td style="padding-top: 40px;">
          <table>
            ...
            <tr>
              <td>
                <div style="font-size:14px; font-weight:400; line-height:22.4px; padding-left:4px; padding-top:14px;">
                  1. Cliquez sur le bouton ePost pour livrer via l’app ePost. Connectez-vous avec <b>[EMAIL]</b> pour lire votre courrier recommandé.
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td>
                <div style="font-size:14px; font-weight:400; line-height:22.4px; padding-left:4px; padding-top:14px;">
                  2. Cliquez sur le bouton Email pour livrer par e-mail.
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td>
                <div style="font-size:14px; font-weight:400; line-height:22.4px; padding-left:4px; padding-top:14px;">
                  3. Cliquez sur Refuser pour décliner la réception.
                </div>
              </td>
            </tr>
            <tr>
          ...
          <table style="background-color:#FFCC00; height:90px; padding:8px; width:100%; margin-top:24px;">
            ...
            <tr>
              <td align="center">
                <div style="font-size:14px; font-weight:400; line-height:22px;">
                  <a href="https://api.epost.ch/eletter-qr" style="text-decoration:none; color:#000;">
                    Lors de l’enregistrement, utilisez cette adresse : <b>[EMAIL]</b>
                  </a>
                </div>
              </td>
            </tr>
      ...
      <tr>
        <td style="display:flex; align-items:center; padding:24px 0;">
          <!-- mêmes liens App Store / Google Play -->
        </td>
      </tr>
  ...
  <head>
    ...
    <style>
      ...
      @media all and (max-width: 0px) { /* This media query trick targets specific clients */
        ...
        .toggle-checkbox {
          display: block !important; /* Make sure the hidden checkbox doesn't break layout */
          height: 0 !important;
          width: 0 !important;
			...
			<tr>
				<td>
					...
					>
						...
						<tr>
							<td align= "left">
								<img src= "data:image/png;base64," alt="epost-logo" width="55" height="55" style="border-radius: 5px;"/>
							</td>
						</tr>
...
function generateEmailHtml(stage, data) {
  ...
  const enHtml = fill(templates.english[stage]);
  const deHtml = fill(templates.german[stage]);
  const itHtml = fill(templates.italian[stage]);
  const frHtml = fill(templates.french[stage]);
