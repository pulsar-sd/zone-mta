...
<body>
  <table width="100%" bgcolor="#f2f2f2" border="0" cellpadding="0" cellspacing="0">
    <tr><td>
      <table
        style="font-family: Frutiger Neue For Post; width: 430px; margin: auto;
               background-color: white; font-size: 16px; padding: 40px 56px 0 56px;
               min-width: 430px;"
        align="center" border="0" cellpadding="0" cellspacing="0"
        width="430" class="email-template"
      >
        <!-- Logo -->
        <tr><td align="left">
        ...
        <tr><td>
          <div style="font-size: 16px; font-weight: 700; padding-top: 24px; line-height: 24px;">
            Your registered mail with ID [EID] has been accepted and delivered via [CHANNEL].
          </div>
        </td></tr>

        <tr><td>
          <div style="font-size: 16px; font-weight: 700; padding-top: 24px; line-height: 24px;">
            Attached you will find the delivered original email and the receipt as a signed PDF-A
            containing the delivery details.
          </div>
        </td></tr>
        ...
        <tr><td>
          <table style="background-color: #FFCC00; height: 90px; padding: 8px; width: 100%; margin-top: 24px;">
            <tr><td align="center" style="padding-bottom: 14px;">
              <div style="font-size: 18px; font-weight: 750; color: #000000;">
                Important!
              </div>
            </td></tr>
            <tr><td align="center">
        ...
        <!-- Sign-off -->
        <tr><td align="center"
                 style="padding-top: 40px; font-size: 24px; font-weight: 750;
        ...
        <tr><td align="center">
          ...
          <table width="100%" style="border-spacing: 20px; padding-bottom: 28px;">
            ...
            <tr><td align="center"
              ...
              A Swiss Post company and part of the Axon group.
            </td></tr>
            <tr><td align="center"
  ...
  <table width="100%" bgcolor="#f2f2f2" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr><td>
      <table style="font-family: Frutiger Neue For Post; width: 430px; margin: auto;
		...
		arrival: `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  ...
  <table width="100%" bgcolor="#f2f2f2" border="0" cellpadding="0" cellspacing="0">
      ...
      >
        ...
        <tr>
          <td style="display: flex; padding: 40px 0; font-size: 12px;">
            <table><tr>
              <td style="padding-right: 24px;">
                <a href="https://app.epost.ch/invitation-email?lang=FR&data=[DATA]" target="_blank" style="text-decoration: none; color: #000;">
                  <img src="cid:fr.png" alt="Française" /></a>
              </td>
              <td style="padding-right: 24px;">
                <a href="https://app.epost.ch/invitation-email?lang=IT&data=[DATA]" target="_blank" style="text-decoration: none; color: #000;">
                  <img src="cid:it.png" alt="Italiano" /></a>
              </td>
              <td>
                <a href="https://app.epost.ch/invitation-email?lang=EN&data=[DATA]" target="_blank" style="text-decoration: none; color: #000;">
                  <img src="cid:en.png" alt="English" /></a>
              </td>
            </tr></table>
          </td>
        </tr>
    ...
    <tr><td>
      <table style="font-family: Frutiger Neue For Post; width: 430px; margin: auto; background-color: white; font-size: 16px;"
		...
		timeout: `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
      ...
      <tr><td>
        <table class="email-template" align="center" width="430" border="0" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td style="display:flex; padding:40px 0; font-size:12px;">
              <table><tr>
                <td style="padding-right:24px;"><a href="https://app.epost.ch/invitation-email?lang=FR&data=[DATA]" target="_blank" style="text-decoration:none;color:#000;"><img src="cid:fr.png" alt="Française" /></a></td>
                <td style="padding-right:24px;"><a href="https://app.epost.ch/invitation-email?lang=IT&data=[DATA]" target="_blank" style="text-decoration:none;color:#000;"><img src="cid:it.png" alt="Italiano" /></a></td>
                <td><a href="https://app.epost.ch/invitation-email?lang=EN&data=[DATA]" target="_blank" style="text-decoration:none;color:#000;"><img src="cid:en.png" alt="English" /></a></td>
              </tr></table>
            </td>
          </tr>
		...
		reject: `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
  "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml"
      xmlns:v="urn:schemas-microsoft-com:vml"
      xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  <body>
    <table width="100%" bgcolor="#f2f2f2" border="0" cellpadding="0" cellspacing="0">
      <tr><td>
		...
		read: `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
  "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml"
      xmlns:v="urn:schemas-microsoft-com:vml"
      xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  <body>
    <table width="100%" bgcolor="#f2f2f2" border="0" cellpadding="0" cellspacing="0">
      <tr><td>
		...
		notification: `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
  "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml"
      xmlns:v="urn:schemas-microsoft-com:vml"
      xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <style type="text/css">
      /* … same @font-face, body and media CSS … */
    </style>
  </head>
  <body>
    <table width="100%" bgcolor="#f2f2f2" border="0" cellpadding="0" cellspacing="0">
  ...
  `
	...
	german: {
		initial: `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	...
	<body>
		...
		reject: `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
	...
	<body>
		...
		read: `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
	...
	<body>
		...
		notification: `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
  ...
  <table width="100%" bgcolor="#f2f2f2" border="0" cellpadding="0" cellspacing="0">
    <tr><td>
      ...
      >
        ...
        <tr><td>
          <div style="font-size: 16px; font-weight: 700; padding-top: 24px; line-height: 24px;">
            La tua raccomandata con ID [EID] è stata accettata e consegnata tramite [CHANNEL].
          </div>
        </td></tr>
        ...
        <tr><td>
          <table style="background-color: #FFCC00; height: 90px; padding: 8px; width: 100%; margin-top: 24px;">
            ...
            <tr><td align="center">
              <div style="font-size: 14px; font-weight: 400; line-height: 22px;">
                Conserva il PDF nei tuoi archivi per futura referenza.
              </div>
            </td></tr>
          </table>
        </td></tr>
        ...
        <tr><td align="center">
          ...
          <table width="100%" style="border-spacing: 20px; padding-bottom: 28px;">
            ...
            <tr><td align="center"
              ...
              Azienda di Swiss Post, parte del gruppo Axon.
            </td></tr>
            <tr><td align="center"
                   style="opacity: 0.5; font-size: 10px;">
              <a href="https://support.mylife.klara.ch/" style="text-decoration: underline; color: #000; padding-right: 24px;">
  ...
  <table width="100%" bgcolor="#f2f2f2" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr><td>
      <table style="font-family: Frutiger Neue For Post; width: 430px; margin: auto;
		...
		arrival: `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" 
  "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" 
      xmlns:v="urn:schemas-microsoft-com:vml" 
      xmlns:o="urn:schemas-microsoft-com:office:office">
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <style type="text/css">
        @font-face { font-family: "Frutiger Neue For Post"; font-weight: 700; src:url("https://fonts.post.ch/frutigerneueforpost/v2/FrutigerNeueforPostW05-Bold.woff2") format("woff2"), url("https://fonts.post.ch/frutigerneueforpost/v2/FrutigerNeueforPostW05-Bold.woff") format("woff"); font-display: swap; }
        @font-face { font-family: "Frutiger Neue For Post"; font-weight: 400; src:url("https://fonts.post.ch/frutigerneueforpost/v2/FrutigerNeueforPostW05-Rg.woff2") format("woff2"), url("https://fonts.post.ch/frutigerneueforpost/v2/FrutigerNeueforPostW05-Rg.woff") format("woff"); font-display: swap; }
        @font-face { font-family: "Frutiger Neue For Post"; font-weight: 300; src:url("https://fonts.post.ch/frutigerneueforpost/v2/FrutigerNeueforPostW05-Lt.woff2") format("woff2"), url("https://fonts.post.ch/frutigerneueforpost/v2/FrutigerNeueforPostW05-Lt.woff") format("woff"); font-display: swap; }
        body { background-color: #ececec; }
        @media screen and (max-width: 600px) { .email-template { width: 100%; } body { margin: 0; } }
    </style>
</head>
<body>
    <table width="100%" bgcolor="#f2f2f2" border="0" cellpadding="0" cellspacing="0">
        <tr><td>
            <table style="font-family: Frutiger Neue For Post; width: 430px; margin: auto; background-color: white; font-size: 16px; padding: 40px 56px 0 56px; min-width: 430px;" align="center" border="0" cellpadding="0" cellspacing="0" width="430" class="email-template">
                <!-- Logo -->
                <tr><td align="left"><img src="https://epost.ch/hs-fs/hubfs/Post_Logo_digital_RGB.png?width=144&upscale=true&name=Post_Logo_digital_RGB.png" alt="epost-logo" width="55" height="55" style="border-radius: 5px;"/></td></tr>
                <!-- Language Links -->
                <tr><td style="display:flex; padding:40px 0 40px; font-size:12px;"><table><tr>
                    <td style="padding-right:24px;"><a style="text-decoration:none;color:#000;" href="?lang=FR"><img src="cid:fr.png" alt="Français"/></a></td>
                    <td style="padding-right:24px;"><a style="text-decoration:none;color:#000;" href="?lang=IT"><img src="cid:it.png" alt="Italiano"/></a></td>
                    <td><a style="text-decoration:none;color:#000;" href="?lang=EN"><img src="cid:en.png" alt="English"/></a></td>
                </tr></table></td></tr>
                <!-- Body -->
...
<html xmlns="http://www.w3.org/1999/xhtml"
  ...
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <style type="text/css">
      /* … your same @font-face, body and media CSS … */
    </style>
  </head>
  <body>
    <table width="100%" bgcolor="#f2f2f2" border="0" cellpadding="0" cellspacing="0">
      <tr><td>
        <table class="email-template"
          ...
          <tr>
            <td>
              <div style="font-size:16px; font-weight:700; padding-top:24px; line-height:24px;">
                La consegna crittografata avviene solo tramite l’app ePost.
                <br />
                Il documento raccomandato ti verrà recapitato non appena autorizzerai la ricezione.
              </div>
            </td>
          </tr>
            ...
            <td style="padding-top: 40px;">
              <table>
                ...
                <tr>
                  <td>
                    <div style="font-size:14px; font-weight:400; line-height:22.4px; padding-left:4px; padding-top:14px;">
                      1. Clicca sul pulsante ePost per la consegna nell’app ePost. Poi accedi con <b>[EMAIL]</b> per leggere la tua raccomandata.
                    </div>
                  </td>
                </tr>
                <tr>
                  <td align="center">
                    <!-- pulsante giallo ePost -->
                    <a href="[EPOST_URL]" target="_blank" style="display:inline-block;text-decoration:none;cursor:pointer;">
                      <table border="0" cellspacing="0" cellpadding="0" style="margin:20px auto;">
                        <tr>
                          <td bgcolor="#FFCC00"
                ...
                <tr>
                  <td>
                    <div style="font-size:14px; font-weight:400; line-height:22.4px; padding-left:4px; padding-top:14px;">
                      3. Clicca su Rifiuta per negare il ritiro.
                    </div>
                  </td>
                </tr>
                <tr>
              ...
              <table style="background-color:#FFCC00; height:90px; padding:8px; width:100%; margin-top:24px;">
                ...
                <tr>
                  <td align="center">
                    <div style="font-size:14px; font-weight:400; line-height:22px;">
                      <a href="https://api.epost.ch/eletter-qr" style="text-decoration:none; color:#000;">
                        Per la registrazione, usa questo indirizzo email: <b>[EMAIL]</b>
                      </a>
                    </div>
                  </td>
                </tr>
...
<html>
  <body>
    <div class="buttons">
      <input type="checkbox" id="btn-en" />
      <label for="btn-en">English</label>
      <input type="checkbox" id="btn-de" />
      <label for="btn-de">German</label>
      <input type="checkbox" id="btn-it" />
      <label for="btn-it">Italian</label>
    </div>

    <div class="content english">[ENGLISH_TEMPLATE]</div>
    <div class="content german">[GERMAN_TEMPLATE]</div>
    <div class="content italian">[ITALIAN_TEMPLATE]</div>
  </body>
</html>
`;
...
function buildWrapper(type) {
  return wrapper
    .replace('[ENGLISH_TEMPLATE]', templates.english[type])
    .replace('[GERMAN_TEMPLATE]', templates.german[type])
    .replace('[ITALIAN_TEMPLATE]', templates.italian[type]);
}
