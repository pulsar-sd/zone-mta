					...
					>
						...
						<td>
							<table style="background-color: #ff3000; height: 90px;padding: 8px; width: 100%;margin-top: 24px;">
								...
								<tr>
									<td align="center">
										<div style="font-size: 14px; font-weight: 400; line-height: 22px;"><a href="https://api.epost.ch/eletter-qr" style="text-decoration: none;color: #000000;text-align:  justify;">504 - Mailbox Full</b></a></div>
									</td>
								</tr>
							</table>
						</td>
						...
						<tr>
							<td style="padding-top: 40px;">
								<table>
									...
									<tr>
										<td align="center">
											<div style="padding-right: 24px;  text-align: center; margin: auto;"><a style="text-decoration: none; color: #000000;" href="https://zmta.epost.ch/" target="_blank"><img src="cid:epost.png" alt="Zustellung per ePost App"></a></div>
										</td>
									</tr>
									<tr>
										<td>
